  ...
  return (
    <div id="news">
        ...
        <div id="cardNews">
            ...
            <Link className='card flex flex-h justify shadow'>
            <div className='illustration' style={{backgroundImage: "url('/articles/3.jpg')"}} />
            <div className='cardText'>
            ...
            <Link className='card flex flex-h justify shadow'>
            <div className='illustration' style={{backgroundImage: "url('/articles/4.jpg')"}} />
            <div className='cardText'>
            ...
            <Link className='card flex flex-h justify shadow'>
            <div className='illustration' style={{backgroundImage: "url('/articles/5.jpg')"}} />
            <div className='cardText'>
            ...
            <Link className='card flex flex-h justify shadow'>
            <div className='illustration' style={{backgroundImage: "url('/articles/6.jpg')"}} />
            <div className='cardText'>
